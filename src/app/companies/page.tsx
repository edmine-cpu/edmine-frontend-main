...
export default function CompaniesPage({
	...
	const applyFilters = () => {
		...
		const basePath = `/companies/${countrySlug}/${citySlug}/${categorySlug}/${subcategorySlug}`
		const path = getLangPath(basePath, lang)
	...
	const resetFilters = () => {
		...
		// Update URL without navigation
		const resetPath = getLangPath('/companies/all/all/all/all', lang)
							...
							{companies.map((company, index) => (
								...
								>
									...
									<div className='flex items-center justify-between text-sm text-gray-600'>
										...
										<a
											href={getLangPath(`/companies/detail/${company.slug}`, lang)}
