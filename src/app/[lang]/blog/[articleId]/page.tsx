                    ...
                    <article className="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div className="p-6 md:p-8">
                            ...
                            <div className="flex flex-wrap items-center text-sm text-gray-500 mb-6 pb-4 border-b border-gray-200">
                                <span className="mr-6">
                                    <span className="font-medium">{t.by}</span> {article.author_name}
                                </span>
                                <span>
                                    <span className="font-medium">{t.date}</span> {formatDate(article.created_at)}
                                </span>
                            </div>
                            ...
                            {article.keywords && (
                                <div className="mt-8 pt-6 border-t border-gray-200">
                                    <h3 className="text-sm font-medium text-gray-500 mb-2">Ключові слова:</h3>
