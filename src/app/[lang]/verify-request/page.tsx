...
const translations = {
  ...
  de: {
    ...
    instruction: 'Geben Sie den Bestätigungscode ein, der an Ihre E-Mail gesendet wurde:',
...
function VerifyRequestContent({ params }: { params: Promise<{ lang: string }> }) {
...
export default function VerifyRequestPage({ params }: { params: Promise<{ lang: string }> }) {
  return (
